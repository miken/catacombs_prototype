...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SchoolParticipation.imported_thru'
        db.add_column(u'datacombo_schoolparticipation', 'imported_thru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacombo.ImportSession'], null=True),
                      keep_default=False)

        # Adding field 'School.imported_thru'
        db.add_column(u'datacombo_school', 'imported_thru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacombo.ImportSession'], null=True),
                      keep_default=False)

        # Adding field 'Response.imported_thru'
        db.add_column(u'datacombo_response', 'imported_thru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacombo.ImportSession'], null=True),
                      keep_default=False)

        # Adding field 'Student.imported_thru'
        db.add_column(u'datacombo_student', 'imported_thru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacombo.ImportSession'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SchoolParticipation.imported_thru'
        db.delete_column(u'datacombo_schoolparticipation', 'imported_thru_id')

        # Deleting field 'School.imported_thru'
        db.delete_column(u'datacombo_school', 'imported_thru_id')

        # Deleting field 'Response.imported_thru'
        db.delete_column(u'datacombo_response', 'imported_thru_id')

        # Deleting field 'Student.imported_thru'
        db.delete_column(u'datacombo_student', 'imported_thru_id')
