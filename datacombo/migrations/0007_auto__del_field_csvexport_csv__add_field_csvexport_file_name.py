...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CSVExport.csv'
        db.delete_column(u'datacombo_csvexport', 'csv')

        # Adding field 'CSVExport.file_name'
        db.add_column(u'datacombo_csvexport', 'file_name',
                      self.gf('django.db.models.fields.CharField')(default=u'unnamed.csv', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CSVExport.csv'
        db.add_column(u'datacombo_csvexport', 'csv',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)

        # Deleting field 'CSVExport.file_name'
        db.delete_column(u'datacombo_csvexport', 'file_name')
