...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomRecode'
        db.create_table(u'datacombo_customrecode', (
            ...
            ('orig_code', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('recode', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'datacombo', ['CustomRecode'])


    def backwards(self, orm):
        # Deleting model 'CustomRecode'
        db.delete_table(u'datacombo_customrecode')
