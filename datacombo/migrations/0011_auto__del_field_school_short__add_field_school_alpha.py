...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'School.short'
        db.delete_column(u'datacombo_school', 'short')

        # Adding field 'School.alpha'
        db.add_column(u'datacombo_school', 'alpha',
                      self.gf('django.db.models.fields.CharField')(default='Moscow High', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'School.short'
        db.add_column(u'datacombo_school', 'short',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Deleting field 'School.alpha'
        db.delete_column(u'datacombo_school', 'alpha')
