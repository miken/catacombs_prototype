...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SchoolParticipation.legacy_school_short'
        db.add_column(u'datacombo_schoolparticipation', 'legacy_school_short',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SchoolParticipation.legacy_school_short'
        db.delete_column(u'datacombo_schoolparticipation', 'legacy_school_short')
