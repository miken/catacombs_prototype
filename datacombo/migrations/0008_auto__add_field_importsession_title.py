...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportSession.title'
        db.add_column(u'datacombo_importsession', 'title',
                      self.gf('django.db.models.fields.CharField')(default=u'Session with no name', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportSession.title'
        db.delete_column(u'datacombo_importsession', 'title')
