...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SchoolParticipation.note'
        db.alter_column(u'datacombo_schoolparticipation', 'note', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'SchoolParticipation.note'
        db.alter_column(u'datacombo_schoolparticipation', 'note', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
